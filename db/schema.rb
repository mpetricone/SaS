...
ActiveRecord::Schema[7.0].define(version: 2024_09_07_185219) do
  ...
  create_table "address_clients", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "address_contacts", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "address_distributers", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "address_id"
  ...
  create_table "authenticity_tokens", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "client_contacts", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "client_id"
    t.integer "contact_id"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "client_emails", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "email"
  ...
  create_table "client_notes", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "client_id"
    t.text "note"
    t.string "title"
    t.datetime "created_at", precision: nil
  ...
  create_table "client_phones", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "number"
    t.string "description"
    t.integer "client_id"
    t.datetime "created_at", precision: nil
  ...
  create_table "client_rates", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "client_id"
    t.integer "rate_id"
    t.boolean "current"
  ...
  create_table "contact_distributers", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "contact_id"
    t.integer "distributer_id"
    t.string "description"
    t.datetime "created_at", precision: nil
  ...
  create_table "contact_emails", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "address"
    t.integer "contact_id"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "contact_phones", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "number"
    t.string "phone_type"
    t.integer "contact_id"
    t.datetime "created_at", precision: nil
  ...
  create_table "distributer_emails", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "distributer_id"
    t.string "email"
    t.string "description"
    t.datetime "created_at", precision: nil
  ...
  create_table "distributer_phones", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "distributer_id"
    t.string "number"
    t.string "description"
    t.datetime "created_at", precision: nil
  ...
  create_table "distributer_products", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "distributer_id"
  ...
  create_table "distributers", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "employee_permissions", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "expense_payments", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "amount"
    t.string "identifier"
  ...
  create_table "expense_types", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "description"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  ...
  create_table "expenses", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "cost"
  ...
  create_table "ou_addresses", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "ou_id"
    t.integer "address_id"
    t.boolean "delivery"
    t.boolean "invoice"
  ...
  create_table "ou_emails", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "ou_id"
    t.string "address"
    t.string "description"
    t.datetime "created_at", precision: nil
  ...
  create_table "ou_payment_types", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.date "date_enabled"
    t.date "date_retired"
    t.string "method"
  ...
  create_table "ou_phones", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "ou_id"
    t.string "number"
    t.string "description"
    t.datetime "created_at", precision: nil
  ...
  create_table "ous", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.integer "root_id"
    t.datetime "created_at", precision: nil
  ...
  create_table "permissions", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "product_notes", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "product_id"
    t.string "title"
    t.text "note"
    t.datetime "created_at", precision: nil
  ...
  create_table "product_tickets", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "ticket_id"
    t.integer "product_id"
  ...
  create_table "rates", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "rate"
    t.boolean "current"
    t.date "date_implemented"
    t.date "date_retired"
  ...
  create_table "shipment_trackings", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "ticket_id"
  ...
  create_table "standings", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  end

  create_table "taxes", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "ticket_action_statuses", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "status"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  end

  create_table "ticket_actions", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "ticket_id"
  ...
  create_table "ticket_expenses", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "ticket_id"
    t.integer "expense_type_id"
    t.bigint "employee_id"
  ...
  create_table "ticket_infos", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "ticket_id"
    t.integer "employee_id"
    t.text "info"
    t.datetime "created_at", precision: nil
  ...
  create_table "ticket_payments", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "ticket_id"
    t.string "payment"
  ...
  create_table "ticket_statuses", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  end

  create_table "ticket_times", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "ticket_id"
    t.date "date"
    t.time "time_start"
    t.time "time_end"
  ...
  create_table "ticket_work_types", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "ticket_id"
  ...
  create_table "work_types", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: nil
    t.datetime "updated_at", precision: nil
  end
