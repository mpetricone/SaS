...
class OusControllerTest < ActionController::TestCase
  ...
  def teardown
    ...
    # I am not sure about the above line, re-enabled it
    logout_admin
  end

  test 'should not access any ou data' do
    should_not_access_data @ou, update_params 
    patch :set_disabled, params: { id: @ou.id }
    assert_redirected_to home_index_path
    patch :clear_disabled, params: { id: @ou.id }
    assert_redirected_to home_index_path
  end
    

  test 'should set disable' do
    patch :set_disabled, params:  {id: @ou.id } 
    assert_redirected_to ous_path
  end

  test 'should clear disable' do
    patch :clear_disabled, params: { id: @ou.id } 
    assert_redirected_to ous_path
  end
